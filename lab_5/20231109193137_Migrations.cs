    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tabels1", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tabel1ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tabels2", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tabels2_tabels1_tabel1ID",
                        column: x => x.tabel1ID,
                        principalTable: "tabels1",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
